...
LAYOUT(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   SFT_SLSH,
  KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, LT2_SPC,     KC_SPC,       LT1_ENT, KC_LCTL, KC_LEFT, KC_DOWN, KC_RGHT
),
...
LAYOUT( /* Q */
  ...
  _______, _______, _______, _______, KC_BTN1,     KC_BTN1,      KC_BTN1, KC_BTN3, KC_MS_L, KC_MS_D, KC_MS_R
),
};
