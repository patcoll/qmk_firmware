...
[_QWERTY] = LAYOUT(
  LALT_T(KC_GRV),   KC_1,             KC_2,    KC_3,                 KC_4,    KC_5,           KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
  ...
  KC_LSFT,          KC_LCTL, KC_LGUI, KC_LALT, LT(_LOWER, KC_SPC),   KC_SPC,  LCTL_T(KC_ENT), LT(_RAISE, KC_BSPC),   KC_LALT, KC_LEFT, KC_DOWN,   KC_RGHT
),
...
[_MOUSE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, KC_BTN1, KC_BTN1, KC_BTN3, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R
),
