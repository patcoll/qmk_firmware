...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,          KC_LCTL, KC_LGUI, KC_LALT, LT(_LOWER, KC_SPC),   KC_SPC,  LCTL_T(KC_ENT), LT(_RAISE, KC_BSPC),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, KC_MUTE,
  _______, _______, _______, _______, _______, _______, KC_LCTL, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, KC_MUTE,
  _______, _______, _______, _______, _______, _______, KC_LCTL, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_MOUSE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, KC_BTN1, KC_BTN1, KC_BTN3, KC_BTN2, _______, _______, _______
),
